									...
									<div class="form-group col-lg-6 pl-5 pr-5">
										...
										<div class="form-groupw-100">
											<div class="input-group-prepend ">
												<span class="input-group-text line-height-2-4 text-16 currency-code-show">BOB</span>
									...
									<div class="form-group col-lg-6 pl-5 pr-5">
										...
										<select id='price-select-currency_code' name="currency_code" class='form-control text-16 mt-2'>
											@foreach($currency as $key => $value)
												@if ($key == 'BOB')
													<option value="{{$key}}" {{'BOB' == $key?'selected':''}}>{{$value}}</option>
												@endif
											@endforeach
										</select>
									</div>
										...
										<div class="col-md-12 pl-3 pr-3 pl-sm-5 pr-sm-5 mt-3">
											<div class="input-group">
												<div class="input-group mb-3">
													<div class="input-group-prepend">
														<span class="input-group-text text-16 currency-code-show">BOB</span>
													</div>
	...
	<script type="text/javascript">
		...
		$('[name=currency_code]').change(function () {
			value = $(this).val();
			$('.currency-code-show').html(value);
		});
