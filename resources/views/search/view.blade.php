                             ...
                             <div class="mt-4">
                                 <div class="col-sm-12">
                                    ...
                                    <div class="row p-3 ml-4">
                                        ...
                                        <div style="display: none" class="pl-4 pr-4 pt-2 min-w-250">
                    ...
                    success: function (result) {
                        ...
                        for (var key in properties) {
                            if (properties.hasOwnProperty(key)) {
                                ...
                                console.log(properties[key].property_price.currency);
                                ...
                                beds = properties[key].beds;
                                bathrooms = properties[key].bathrooms;
                                bedrooms = properties[key].bedrooms;
                                bedrooms = properties[key].bedrooms;
                                city = properties[key].property_address.city;
                                price = properties[key].property_price.price;
                                ...
                                room_point[key] = {
                                    ...
                                    +'<div class="map-property-name">'
                                        ...
                                        +'<div class="col-xs-12 p-1">'
                                            ...
                                            +'<div class="location-title"><h5>'+bedrooms+' Dormitorios '+bathrooms+' Baños '+beds+' Camas</h5></div>'
                                            +'<div class="d-flex justify-content-between">'
                                            +'<div><p class="text-13 mt-2 mb-0 text"><i class="fas fa-map-marker-alt"></i> '+city+'</p></div>'
                                            +'<div><span><i class="fa fa-star text-14 yellow_color"></i> 0 (0)</span></div>'
                                            +'</div>'
                                            +'<div class="svred text-14"><span class="font-weight-700">'+price+' $ / Noche </span><i class="icon icon-instant-book yellow_color text-25" aria-hidden="true"></i></div>'
                                        +'</div>'
                                    +'</div>'
        ...
        $(document).ready(function(){
         ...
         //on map click btn function
          $("#map-btn").click(function(){
            ...
            $('#mapCol').attr('class', 'col-md-4 p-0');
            ...
            $('#listCol').attr('class', 'col-md-8 p-0');
          ...
          $("#res-btn").click(function(){
              ...
              $('#listCol').attr('class', 'col-md-12 p-0');
